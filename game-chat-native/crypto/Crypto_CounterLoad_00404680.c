...

{
  ...
  if ((param_1 != (uint *)0x0) && (in_EAX != (uint *)0x0)) {
    ...
    *in_EAX = uVar2 >> 8 & 0xff00ff00 | uVar2 << 0x18 | (uVar2 & 0xff00) << 8 | uVar2 >> 0x18;
    ...
    in_EAX[3] = uVar3;
    uVar2 = (*(uint *)(&UNK_00790760 + ((uVar2 << 8 & 0xff0000) >> 0x10) * 4) ^ 0x1000000) &
            0xff000000 ^ *(uint *)(&UNK_00790760 + ((uVar2 >> 8 & 0xff00) >> 8) * 4) & 0xff0000 ^
            (uint)(byte)(&UNK_00790760)[(uVar2 & 0xff) * 4] ^
            *(uint *)(&UNK_00790760 + (uVar2 >> 0x18) * 4) & 0xff00 ^ *in_EAX;
    ...
    puVar1 = in_EAX + 1;
    puVar4 = (uint *)&UNK_00791f64;
    do {
      uVar2 = puVar1[6];
      puVar5 = puVar4 + 1;
      uVar2 = *(uint *)(&UNK_00790760 + (uVar2 >> 8 & 0xff) * 4) & 0xff0000 ^
              *(uint *)(&UNK_00790760 + (uVar2 >> 0x10 & 0xff) * 4) & 0xff000000 ^
              (uint)(byte)(&UNK_00790760)[(uVar2 >> 0x18) * 4] ^
              *(uint *)(&UNK_00790760 + (uVar2 & 0xff) * 4) & 0xff00 ^ puVar1[3] ^ *puVar4;
      puVar1[7] = uVar2;
