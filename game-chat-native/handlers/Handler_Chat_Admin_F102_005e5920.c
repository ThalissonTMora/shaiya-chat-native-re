/*
 * Game.exe — Handler_Chat_Admin_F102
 * Requested VA: 0x005E5920
 * Entry Ghidra:  005e5920
 * Ghidra name:   FUN_005e5920
...

{
  ...
  (**(code **)(*DAT_022fa2f0 + 0x328))(local_a0,1,0,&local_9c,local_a4,local_84);
