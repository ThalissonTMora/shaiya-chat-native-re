/*
 * server/ps_game.exe — Zone_PSendViewCellsAlt
 * VA solicitado: 0x00427550
 * Entry Ghidra:  00427550
 * Ghidra name:   FUN_00427550
...
void FUN_00427550(int param_1,undefined4 param_2,undefined4 param_3,int param_4,undefined4 param_5)
  ...
  if (iVar3 != 0) {
    for (; iVar2 <= local_8; iVar2 = iVar2 + 1) {
      if (param_4 <= local_4) {
        ...
        do {
          FUN_0042ada0(iVar3,uVar1,param_5);
          iVar5 = iVar5 + -1;
        } while (iVar5 != 0);
      }
    }
